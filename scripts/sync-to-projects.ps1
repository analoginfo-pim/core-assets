...
$assetMap = [ordered]@{
    ...
    # ----- MSI installer shortcut icons (WiX) -----------------------------
    # Generated by scripts/generate-installer-shortcut-icons.ps1.
    # MSI builds read directly from core-assets via Stage-InstallerShortcutIcons.ps1;
    # the pim-installers mirror is a stable offline copy for scripts that do not
    # pass -CoreAssetsRoot.
